...
namespace TrustMeNews.Controllers
{
    ...
    public class GenresApiController : ControllerBase
    {
        ...
        {
            string apiKeyBySection = $"https://content.guardianapis.com/search?api-key=d0bd9a0e-8101-4525-8604-4ad01023d10c&order-by=newest&show-fields=all&page-size=6&section={genreId.First()}";
